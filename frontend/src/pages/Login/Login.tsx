...
export default function Login() {
  ...
  const {register,handleSubmit,formState:{isValid,errors}}=useForm<dataType>({
    mode:"all",
    defaultValues:{
      identifier:"",
      password:""
    ...
    <>
      ...
      <section className="login-register">
        <div className="login">
          ...
          <form action="#" className="login-form" onSubmit={handleSubmit(userLogin)}>
            <div className="login-form__username">
              <input
                className={`login-form__username-input ${errors.identifier!==undefined?(!errors.identifier?"input-valid":"input-invalid"):"input-default"}`}
                id="username"
                type="text"
